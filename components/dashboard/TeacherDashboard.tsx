    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                <StatCard title="Assigned Classes" value={assignedClasses.length.toString()} color="bg-blue-100 dark:bg-blue-900 dark:bg-opacity-50 text-blue-600 dark:text-blue-300" icon={<BookOpenIcon className="w-6 h-6" />} />
                <StatCard title="Total Students" value={studentsInMyClasses.length.toString()} color="bg-indigo-100 dark:bg-indigo-900 dark:bg-opacity-50 text-indigo-600 dark:text-indigo-300" icon={<UsersIcon className="w-6 h-6" />} />
                <StatCard title="Average Attendance" value={stats.averageAttendance} color="bg-green-100 dark:bg-green-900 dark:bg-opacity-50 text-green-600 dark:text-green-300" icon={<CheckCircleIcon className="w-6 h-6" />} />
                <StatCard title="Subjects Taught" value={stats.subjectsTaught} color="bg-yellow-100 dark:bg-yellow-900 dark:bg-opacity-50 text-yellow-600 dark:text-yellow-300" icon={<ClipboardListIcon className="w-6 h-6" />} />
            </div>
