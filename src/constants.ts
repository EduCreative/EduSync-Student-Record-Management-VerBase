...
export const NAV_LINKS: Record<UserRole, { name: string; path: string; icon: React.ReactElement }[]> = {
    ...
    [UserRole.Admin]: [
        ...
        { name: 'Parents & Students', path: '/users', icon: React.createElement(UsersIcon) },
        ...
        { name: 'Teachers', path: '/teachers', icon: React.createElement(UsersIcon) },
        { name: 'Accountants', path: '/accountants', icon: React.createElement(UsersIcon) },
