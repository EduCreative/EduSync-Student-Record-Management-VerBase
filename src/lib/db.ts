// FIX: Changed Dexie import to be a default import. The named import was incorrect and caused type resolution to fail, preventing access to methods like `version()` and properties like `tables`.
