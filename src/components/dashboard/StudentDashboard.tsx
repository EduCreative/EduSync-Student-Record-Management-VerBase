...
const StudentDashboard: React.FC = () => {
    ...
    return (
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                 <div className="fade-in-up" style={{ animationDelay: '100ms' }}><StatCard title="My Attendance" value="98%" color="bg-green-100 dark:bg-green-900/50 text-green-600 dark:text-green-300" icon={<CheckCircleIcon />} /></div>
                 <div className="fade-in-up" style={{ animationDelay: '200ms' }}><StatCard title="Overall Grade" value="A+" color="bg-blue-100 dark:bg-blue-900/50 text-blue-600 dark:text-blue-300" icon={<AwardIcon />} /></div>
                 <div className="fade-in-up" style={{ animationDelay: '300ms' }}><StatCard title="Fee Status" value="Paid" color="bg-yellow-100 dark:bg-yellow-900/50 text-yellow-600 dark:text-yellow-300" icon={<DollarSignIcon />} /></div>
                 <div className="fade-in-up" style={{ animationDelay: '400ms' }}><StatCard title="Upcoming Exams" value="2" color="bg-red-100 dark:bg-red-900/50 text-red-600 dark:text-red-300" icon={<EditIcon />} /></div>
            </div>
            
            <div className="fade-in-up" style={{ animationDelay: '500ms' }}><BarChart title="Recent Exam Performance (%)" data={recentExamPerformance} multiColor={true} /></div>

            <div className="bg-white dark:bg-secondary-800 p-6 rounded-xl shadow-lg fade-in-up" style={{ animationDelay: '600ms' }}>
