                    ...
                    <form onSubmit={handleLogin} className="space-y-6">
                        ...
                        <div className="flex items-center justify-between text-sm">
                            <label className="flex items-center text-secondary-600 dark:text-secondary-400 cursor-pointer">
                                <input 
                                    className="h-4 w-4 text-primary-600 rounded border-secondary-300 dark:border-secondary-600 focus:ring-primary-500 bg-secondary-50 dark:bg-secondary-800"
                                    type="checkbox"
                                    checked={rememberMe}
