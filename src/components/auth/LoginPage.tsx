    ...
    return (
        <div className="min-h-screen w-full bg-gradient-to-br from-primary-700 via-primary-800 to-primary-950 text-white lg:grid lg:grid-cols-2 relative [background-size:200%] animate-background-pan">
            ...
            <div className="flex items-center justify-center p-6 sm:p-12 w-full lg:py-0 relative">
                <div style={{ animationDelay: '400ms' }} className="fade-in-up w-full max-w-md bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl shadow-2xl p-8 sm:p-10">
