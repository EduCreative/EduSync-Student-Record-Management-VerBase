...
const RegisterPage: React.FC<RegisterPageProps> = ({ onSwitchToLogin }) => {
    ...
    if (success) {
        return (
            <div className="min-h-screen w-full bg-gradient-to-br from-primary-700 to-primary-950 flex flex-col justify-center items-center p-4 text-white">
        ...
        <div className="min-h-screen w-full bg-gradient-to-br from-primary-700 via-primary-800 to-primary-950 text-white lg:grid lg:grid-cols-2 relative [background-size:200%_200%] animate-background-pan">
            ...
            <div className="hidden lg:flex flex-col items-center justify-center p-12 relative">
                <div className="text-center space-y-6">
                    ...
                    <p style={{ animationDelay: '300ms' }} className="fade-in-up mt-4 text-lg text-primary-200 max-w-md mx-auto">
             ...
             <div className="flex items-center justify-center p-6 sm:p-12 w-full lg:py-0 relative">
                <div style={{ animationDelay: '400ms' }} className="fade-in-up w-full max-w-md bg-black/20 backdrop-blur-lg border border-white/20 rounded-2xl shadow-2xl p-8 sm:p-10">
                    ...
                    <form onSubmit={handleRegister} className="space-y-4" noValidate>
                        ...
                        <div className="pt-2">
                            <button type="submit" disabled={loading} className="w-full bg-white text-primary-800 font-bold py-3 px-4 rounded-lg hover:bg-primary-100 transition-colors duration-300 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center">
