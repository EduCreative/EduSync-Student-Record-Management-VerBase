...
const Header: React.FC<HeaderProps> = ({ setSidebarOpen, setActiveView, openAboutModal }) => {
    ...
    return (
        <header className="sticky top-0 z-30 border-b border-secondary-200/50 bg-white/80 dark:border-secondary-700/50 dark:bg-secondary-800/80 backdrop-blur-lg no-print">
